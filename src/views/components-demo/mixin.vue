      ...
      <el-col :span="8">
        <el-card class="box-card">
          ...
          <div class="component-item" style="height:420px;">
            <dropdown-menu :items="articleList" style="margin:0 auto;" title="封装的下拉组件" />
          </div>
        </el-card>
      </el-col>
    </el-row>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      articleList: [
        { title: '1', href: 'https://www.baidu.com' },
        { title: '2', href: 'https://www.baidu.com' },
        { title: '3', href: 'https://www.baidu.com' },
        { title: '4', href: 'https://www.baidu.com' }
      ]
    }
  }
}
